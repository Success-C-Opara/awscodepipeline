pipeline {
    ...
    environment {
        EC2_USER = 'ec2-user'
        EC2_HOST = '18.208.114.61'
        PRIVATE_KEY_PATH = 'C:/Users/Success/Downloads/emcommerce-keypair.pem'
        IMAGE_NAME = 'ecommerce-dockerhub'
        IMAGE_TAG = "build-${env.BUILD_NUMBER}"
        GIT_REPO = 'https://github.com/Success-C-Opara/jenkins-web-ecommerce.git'
        BRANCH_NAME = 'main'
